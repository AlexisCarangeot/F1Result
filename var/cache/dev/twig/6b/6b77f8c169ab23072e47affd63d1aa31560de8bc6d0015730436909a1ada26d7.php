...
class __TwigTemplate_e5ea26828e70f187409ce7d255d59e24434a58946457930b4e311bfd9e68a0a9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"topbar\">
        ...
        echo "\">Accueil</a></li>
            <li><a href=\"";
        // line 13
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("circuit_new");
        echo "\">Circuit</a></li>
            <li><a href=\"";
        // line 14
...
";
    ...
    {
        return array (  173 => 23,  163 => 22,  145 => 9,  132 => 24,  130 => 22,  123 => 18,  118 => 16,  114 => 15,  110 => 14,  106 => 13,  102 => 12,  96 => 9,  90 => 5,  80 => 4,  61 => 3,  38 => 1,);
    }
...
<div class=\"template-admin\">
    <div class=\"topbar\">
        <div class=\"menu\">
            <i class=\"fas fa-users-cog\"></i>
            <p>Admin-{% block titlepage %}{% endblock %}</p>
        </div>
        <ul>
            <li><a href=\"{{ path('admin')}}\">Accueil</a></li>
            <li><a href=\"{{ path('circuit_new')}}\">Circuit</a></li>
            <li><a href=\"{{ path('pilote_new')}}\">Pilote</a></li>
            <li><a href=\"{{ path('team_new')}}\">Écurie</a></li>
            <li><a href=\"{{ path('country_new')}}\">Pays</a></li>
        </ul>
        <a class=\"btn\" href=\"{{ path('index') }}\">Retourner sur le site</a>
    </div>
...
{% endblock %}", "admin/layout.html.twig", "/Applications/MAMP/htdocs/Symfony/Formula/templates/admin/layout.html.twig");
    }
}
