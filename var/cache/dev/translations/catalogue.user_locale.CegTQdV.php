...
$catalogue = new MessageCatalogue('user_locale', array (
));

$catalogueUser = new MessageCatalogue('user', array (
));
$catalogue->addFallbackCatalogue($catalogueUser);
...
$catalogueUser->addFallbackCatalogue($catalogueFr);
