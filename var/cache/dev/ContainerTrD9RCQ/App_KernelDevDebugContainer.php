...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ClassementController' => 'getClassementControllerService',
            'App\\Controller\\CountryController' => 'getCountryControllerService',
            'App\\Controller\\IndexController' => 'getIndexControllerService',
            'App\\Controller\\PiloteController' => 'getPiloteControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HcdIxAy6d2', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HCftpVD3vk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.flag_image' => ['privates', 'vich_uploader.listener.clean.flag_image', 'getVichUploader_Listener_Clean_FlagImageService', true],
            'vich_uploader.listener.clean.pilote_portrait' => ['privates', 'vich_uploader.listener.clean.pilote_portrait', 'getVichUploader_Listener_Clean_PilotePortraitService', true],
            'vich_uploader.listener.clean.team_banner' => ['privates', 'vich_uploader.listener.clean.team_banner', 'getVichUploader_Listener_Clean_TeamBannerService', true],
            'vich_uploader.listener.clean.team_logo' => ['privates', 'vich_uploader.listener.clean.team_logo', 'getVichUploader_Listener_Clean_TeamLogoService', true],
            'vich_uploader.listener.clean.team_monoplace' => ['privates', 'vich_uploader.listener.clean.team_monoplace', 'getVichUploader_Listener_Clean_TeamMonoplaceService', true],
            'vich_uploader.listener.remove.flag_image' => ['privates', 'vich_uploader.listener.remove.flag_image', 'getVichUploader_Listener_Remove_FlagImageService', true],
            'vich_uploader.listener.remove.pilote_portrait' => ['privates', 'vich_uploader.listener.remove.pilote_portrait', 'getVichUploader_Listener_Remove_PilotePortraitService', true],
            'vich_uploader.listener.remove.team_banner' => ['privates', 'vich_uploader.listener.remove.team_banner', 'getVichUploader_Listener_Remove_TeamBannerService', true],
            'vich_uploader.listener.remove.team_logo' => ['privates', 'vich_uploader.listener.remove.team_logo', 'getVichUploader_Listener_Remove_TeamLogoService', true],
            'vich_uploader.listener.remove.team_monoplace' => ['privates', 'vich_uploader.listener.remove.team_monoplace', 'getVichUploader_Listener_Remove_TeamMonoplaceService', true],
            'vich_uploader.listener.upload.flag_image' => ['privates', 'vich_uploader.listener.upload.flag_image', 'getVichUploader_Listener_Upload_FlagImageService', true],
            'vich_uploader.listener.upload.pilote_portrait' => ['privates', 'vich_uploader.listener.upload.pilote_portrait', 'getVichUploader_Listener_Upload_PilotePortraitService', true],
            'vich_uploader.listener.upload.team_banner' => ['privates', 'vich_uploader.listener.upload.team_banner', 'getVichUploader_Listener_Upload_TeamBannerService', true],
            'vich_uploader.listener.upload.team_logo' => ['privates', 'vich_uploader.listener.upload.team_logo', 'getVichUploader_Listener_Upload_TeamLogoService', true],
            'vich_uploader.listener.upload.team_monoplace' => ['privates', 'vich_uploader.listener.upload.team_monoplace', 'getVichUploader_Listener_Upload_TeamMonoplaceService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber' => '?',
            'vich_uploader.listener.clean.flag_image' => '?',
            'vich_uploader.listener.clean.pilote_portrait' => '?',
            'vich_uploader.listener.clean.team_banner' => '?',
            'vich_uploader.listener.clean.team_logo' => '?',
            'vich_uploader.listener.clean.team_monoplace' => '?',
            'vich_uploader.listener.remove.flag_image' => '?',
            'vich_uploader.listener.remove.pilote_portrait' => '?',
            'vich_uploader.listener.remove.team_banner' => '?',
            'vich_uploader.listener.remove.team_logo' => '?',
            'vich_uploader.listener.remove.team_monoplace' => '?',
            'vich_uploader.listener.upload.flag_image' => '?',
            'vich_uploader.listener.upload.pilote_portrait' => '?',
            'vich_uploader.listener.upload.team_banner' => '?',
            'vich_uploader.listener.upload.team_logo' => '?',
            'vich_uploader.listener.upload.team_monoplace' => '?',
        ]), [0 => 'vich_uploader.listener.clean.flag_image', 1 => 'vich_uploader.listener.clean.pilote_portrait', 2 => 'vich_uploader.listener.clean.team_logo', 3 => 'vich_uploader.listener.clean.team_banner', 4 => 'vich_uploader.listener.clean.team_monoplace', 5 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 6 => 'vich_uploader.listener.remove.flag_image', 7 => 'vich_uploader.listener.upload.flag_image', 8 => 'vich_uploader.listener.remove.pilote_portrait', 9 => 'vich_uploader.listener.upload.pilote_portrait', 10 => 'vich_uploader.listener.remove.team_logo', 11 => 'vich_uploader.listener.upload.team_logo', 12 => 'vich_uploader.listener.remove.team_banner', 13 => 'vich_uploader.listener.upload.team_banner', 14 => 'vich_uploader.listener.remove.team_monoplace', 15 => 'vich_uploader.listener.upload.team_monoplace']);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\PiloteRepository' => ['privates', 'App\\Repository\\PiloteRepository', 'getPiloteRepositoryService', true],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W50JbPEc+j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('04lq6dyK8C', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-KNEU0DkX1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KQTL3yWUSW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HyMeII345P', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('argnZXGgh1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'flag_image' => [
                    'uri_prefix' => '/image/country',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/image/country'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
                ...
                'pilote_portrait' => [
                    'uri_prefix' => '/image/pilote/portrait',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/image/pilote/portrait'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
                ...
                'team_logo' => [
                    'uri_prefix' => '/image/team/logo',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/image/team/logo'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
                ...
                'team_banner' => [
                    'uri_prefix' => '/image/team/banner',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/image/team/banner'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
                ...
                'team_monoplace' => [
                    'uri_prefix' => '/image/team/monoplace',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/image/team/monoplace'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
